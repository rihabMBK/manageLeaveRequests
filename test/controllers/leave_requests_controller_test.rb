...
class LeaveRequestsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create leave_request" do
    assert_difference('LeaveRequest.count') do
      post leave_requests_url, params: { leave_request: { endDate: @leave_request.endDate, idRequest: @leave_request.idRequest, reason: @leave_request.reason, startDate: @leave_request.startDate, status: @leave_request.status } }
    end
  ...
  test "should update leave_request" do
    patch leave_request_url(@leave_request), params: { leave_request: { endDate: @leave_request.endDate, idRequest: @leave_request.idRequest, reason: @leave_request.reason, startDate: @leave_request.startDate, status: @leave_request.status } }
